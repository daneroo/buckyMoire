...
#declare Cam_factor = 1.4+clock*1.1;
...
object{ OuterDome 
  rotate <0, 0, (2*clock-clock*clock)*72>
...
normalizedBaseName="zoomOutC4-F${outerFrequency}${innerFrequency}-${aspectRatio}";
