...
# Title: BuckyMoire 
# Description:
#  Generate Moire Pattern From two BuckminsterFuller Domes
...
thumbImage=$workDir/thumbBuckyMoire$normalizedBaseName.png
genImage=$workDir/buckyMoire${normalizedBaseName}-.png
genAnim=$workDir/buckyMoire${normalizedBaseName}.mpg
